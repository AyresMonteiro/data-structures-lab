...
Nos converterNosParaAdjacencias(Adjacencias adj)
{
}
	...
	int verticeInicial)
{
	...
	numeracoes.push_back({first : verticeInicial, second : visitado});
...
int main()
{
	...
	Numeracoes extraidas = extrairNumeracoes(lista, 0);
